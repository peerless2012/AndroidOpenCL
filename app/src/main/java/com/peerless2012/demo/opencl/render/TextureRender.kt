 ...
 * @Description
 */
abstract class TextureRender(private val context: Context): GLSurfaceView.Renderer {

    companion object {

        const val TAG = "TextureRender"
